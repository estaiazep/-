...
export default function HalalInfo({ language }: HalalInfoProps) {
  ...
  return (
    <section className="py-12 sm:py-16 bg-gradient-to-r from-green-900/10 to-blue-900/10 relative overflow-hidden">
      <div className="container mx-auto px-4 sm:px-6">
        <div className="text-center mb-8 sm:mb-12">
          ...
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-4 bg-gradient-to-r from-green-400 to-blue-400 bg-clip-text text-transparent">
          ...
          {halalPoints.map((point, index) => (
            ...
            >
              <CardContent className="p-6 text-center">
                <div className="w-12 h-12 bg-slate-700/50 rounded-xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
        ...
        <div className="bg-slate-800/30 border border-slate-700 rounded-xl p-6 max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="space-y-3">
              <h4 className="text-red-400 font-medium text-center">
            ...
            <div className="space-y-3">
              <h4 className="text-green-400 font-medium text-center">
