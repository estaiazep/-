export const translations = {
  ru: {
    // Header
    trustBadge: "Проверено 1000+ клиентами",
    heroTitle: "Шахмир",
    ...
    // Stats
    yearsTrading: "Лет в трейдинге",
    avgGrowth: "Средний рост капитала",
    commission: "Моя комиссия с прибыли",

    // Image section
    clientResults: "Результаты моих клиентов",
    seeProof: "Нажми, чтобы увидеть доказательства",
    ...
    feature2Description:
      "Ты получаешь 70% прибыли, я беру 30%. Плачу только с результата — если нет прибыли, комиссии нет.",

    feature3Title: "Твой капитал в безопасности",
    feature3Description:
      "Использую только проверенные брокеры и риск-менеджмент. Твои деньги защищены от критических потерь.",

    feature4Title: "Полная прозрачность",
    feature4Description:
  ...
  uz: {
    // Header
    trustBadge: "1000+ mijozlar tomonidan tasdiqlangan",
    heroTitle: "Shahmir",
    ...
    // Stats
    yearsTrading: "Yil treydingda",
    avgGrowth: "O'rtacha kapital o'sishi",
    commission: "Foydadan mening komissiyam",

    // Image section
    clientResults: "Mijozlarimning natijalari",
    seeProof: "Dalillarni ko'rish uchun bosing",
    ...
    feature2Description:
      "Siz foydaning 70%ini olasiz, men 30% olaman. Faqat natijadan to'layman — foyda bo'lmasa, komissiya ham yo'q.",

    feature3Title: "Kapitalingiz xavfsizlikda",
    feature3Description:
      "Faqat tekshirilgan brokerlar va risk-menejmenti ishlataman. Pulingiz kritik yo'qotishlardan himoyalangan.",

    feature4Title: "To'liq shaffoflik",
    feature4Description:
    ...
    riskWarning: "Investitsiyalar xavf bilan bog'liq. Mas'uliyat bilan savdo qiling.",
  },
}
